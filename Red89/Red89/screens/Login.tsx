...
import { Button, StyleSheet, Text, View, TextInput, SafeAreaView, TouchableOpacity, Alert, Modal, Image } from 'react-native';
import { signInWithEmailAndPassword, sendPasswordResetEmail } from 'firebase/auth'; // Cập nhật câu lệnh import
...
const Login: React.FC<LoginProps> = ({ navigation, setIsLoggedIn }) => {
    ...
    const [showModal, setShowModal] = useState<boolean>(false); // State để kiểm soát việc hiển thị modal
    ...
    return (
        <View style={styles.container}>
            ...
            <SafeAreaView style={styles.form}>
                ...
                <TouchableOpacity
                    style={{ marginTop: 40, flexDirection: 'row', alignItems: 'center', alignSelf: 'center' }}
                    onPress={handleGoogleSignIn}
                >
                    <Image
                        source={require('../assets/images/android_light_login_long.png')}
