...
import Edit_in4Personal from '../screen/Edit_in4Personal';
import Add_mem_gr from '../screen/Add_mem_gr';
import Select_Ad from '../screen/Select_Ad';
        ...
        <Tab.Navigator screenOptions={{
            ...
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarLabel: ({ focused }) => (
                        <Text style={{ color: focused ? '#006AF5' : 'black', fontSize: 12 }}>
                            Tin nhắn
                        </Text>
                    ),
                }}
