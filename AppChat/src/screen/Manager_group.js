    ...
    return (
        <><SafeAreaView style={styles.container}>
            ...
            <View style={styles.tab1}>
                {(admin === null && !subAdmin.includes(user.uid))  && (
                    <Pressable onPress={() => setSelectedTab('Tất cả')}>
                        <Text style={{ color: selectedTab === 'Tất cả' ? '#9acd32' : 'black' }}>Tất cả</Text>
                    </Pressable>
                )}
                {(admin !== null || subAdmin.includes(user.uid)) && (
                    <>
                        ...
                        <Pressable onPress={() => setSelectedTab('Trưởng nhóm')}>
                            <Text style={{ color: selectedTab === 'Trưởng nhóm' ? '#9acd32' : 'black' }}>Quản trị nhóm</Text>
                        </Pressable>
                        <Pressable onPress={() => setSelectedTab('Đã mời')}>
                            <Text style={{ color: selectedTab === 'Đã mời' ? '#9acd32' : 'black' }}>Đã mời</Text>
                        </Pressable>
                        <Pressable onPress={() => setSelectedTab('Đã chặn')}>
                            <Text style={{ color: selectedTab === 'Đã chặn' ? '#9acd32' : 'black' }}>Đã chặn</Text>
                        </Pressable>
                    </>
                )}
            </View>
            ...
            <View>
                {selectedTab === 'Tất cả' && (
                    <View>
                        <Text style={{ padding: 2, color: '#9acd32' }}>Thành viên ({memberCount})</Text>
                        <FlatList
